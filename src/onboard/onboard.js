        ...
        return (<React.Fragment>
            {
                ...
                <Navigate to = {"/game/" + this.state.gameId}><button className="btn btn-success" style = {{marginLeft: String((window.innerWidth / 2) - 60) + "px", width: "120px"}}>Começar o jogo</button></Navigate>
